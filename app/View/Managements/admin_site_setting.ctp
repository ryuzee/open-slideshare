...
<div class="panel panel-default">
    ...
    <table class="table table-striped table-bordered small">
        <thead>
            <tr>
                <th class="col-md-1"><?php echo __('Setting'); ?></th>
                <th class="col-md-1"><?php echo __('Value'); ?></th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?php echo $this->Form->input("Config.{$key}.value", array('default' => $config["Config"]['value'], 'label' => false)); ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
